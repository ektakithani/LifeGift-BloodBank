...
btnsubmit.addActionListener(new AfterAddDonor());
setVisible(true);
}
class AfterAddDonor implements ActionListener{//class action
String gender;
...
System.out.println(ag);
			...
			if(Integer.parseInt(txtage.getText())>18 && Integer.parseInt(txtage.getText())<65){//age ka range ka if 
				System.out.println("True");
				System.out.println("age ka range ka if agar int hua toh");
all_fine=true;
				...
				txtage.requestFocus();
				ag=false;
				System.out.println("age ka range ka else agr int hua toh");

			}//else end of age ka range check
...
System.out.println("age ka not int ka else");
	...
	else{JOptionPane.showMessageDialog(c8,"Incorrect Contact Number");
	}
...
if(btnMale.isSelected()) 
        ...
        gender="Female";
new DbHandlerBDM().addDonor(fname,lname,gender,age,contact,address,bgroup);
